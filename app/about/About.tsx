        ...
        <div className="relative">
          ...
          <div className="mx-auto px-4 pt-32 sm:px-12 sm:pt-40 md:pt-48 lg:pt-56 xl:max-w-6xl xl:px-0">
            <div className="flex flex-col z-10">
              <p className="text-center text-5xl font-bold text-blue-900 dark:text-white sm:text-6xl lg:text-left lg:text-7xl">
                Expert 8
              </p>
              <p className="text-5xl sm:text-6xl lg:text-left lg:text-7xl font-bold bg-gradient-to-r from-blue-600 via-sky-500 to-indigo-400 inline-block text-transparent bg-clip-text">
                Solution
              </p>
            ...
            <div className="grid grid-cols-2 my-40">
              ...
              <div className="flex flex-col justify-center p-2">
                <span className="text-sm font-semibold uppercase tracking-widest text-blue-500 dark:text-secondaryLight">
                  อาจารย์ผู้สอน
                </span>
                <p className="text-3xl font-bold text-gray-800 dark:text-white md:text-4xl xl:text-5xl">
                  นาย รนกฤต เชียรวิชัย
                </p>
                <p className="mt-8 font-semibold text-gray-600 dark:text-gray-300">
                  ประวัติการศึกษา ( Education )
                </p>
                <p className="mb-12 mt-4 text-gray-600 dark:text-gray-300">
                  ปริญญาตรีคณะวิศวกรรมศาสตร์ โยธาเเละการบริหารธุรกิจก่อสร้าง
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mx-auto px-4 sm:px-12 xl:max-w-5xl xl:px-0">
              ...
              <div className="relative mt-32 hidden h-40 w-40 items-center justify-center lg:mx-auto lg:flex">
                <div className="it absolute inset-0 flex flex-wrap blur-3xl">
                  ...
                  <div
                    aria-hidden="true"
                    className="h-1/2 w-1/2 rounded-br-full bg-purple-700"
                  ></div>
                </div>
                  ...
                  <div className="relative -mt-12">
                    <h2 className="mb-8 text-4xl font-bold text-blue-900 dark:text-white md:text-6xl">
                      ...
                      <span className="relative">
                        ...
                        <span className="relative px-2 text-sky-800 dark:text-indigo-200">
                          Expert8Solution
                        </span>
                      </span>
                    </h2>
                    ...
                    <a
                      href="contact.html"
                      className="relative rounded-3xl mx-auto flex h-11 w-max items-center bg-sky-600 justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition-transform before:duration-300 active:duration-75 active:before:scale-95 dark:before:bg-primaryLight"
                    >
