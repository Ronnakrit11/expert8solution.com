          ...
          <div className="mx-auto px-4 pt-32 sm:px-12 sm:pt-40 md:pt-48 lg:pt-56 xl:max-w-6xl xl:px-0">
            ...
            <div className='grid grid-cols-2 my-40'>
              ...
              <div className='flex flex-col justify-center p-2'>
                ...
                <p className='text-3xl font-bold text-gray-800 dark:text-white md:text-4xl xl:text-5xl'>นาย รนกฤต เชียรวิชัย</p>
                <p className='mt-8 font-semibold text-gray-600 dark:text-gray-300'>ประวัติการศึกษา ( Education )</p>
                <p className='mb-12 mt-4 text-gray-600 dark:text-gray-300'>ปริญญาตรีคณะวิศวกรรมศาสตร์ โยธาเเละการบริหารธุรกิจก่อสร้าง</p>
              </div>
            </div>
          </div>
