            ...
            <div className='bg-[#101828] dark:bg-darkbg py-20 px-4'>
                <div className='container mx-auto'>
                    <div className='mb-8'>
                        ...
                        <p className='text-[16px] text-[#7f848c] w-auto sm:w-auto lg:w-[700px]'>บริษัท แน็คซ์ คอร์ปอเรชั่น จำกัด เป็นบริษัทก่อตั้งขึ้นในปี พ.ศ. 2561
                            บริษัท start up สำหรับคนรุ่นใหม่ โดยมุ่งเน้นในเรื่องการเขียนโปรแกรมและพัฒนา software เพื่อให้ลูกค้าได้ประโยชน์จากการใช้งานได้สูงสุดเราเปลี่ยนไอเดียของลูกค้าให้เป็นธุรกิจ หรือโปรแกรมที่ใช้งานได้จริงขับเคลื่อนเติบโตไปพร้อมกับลูกค้าอย่างมืออาชีพ</p>
                    </div>
                    <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2'>
                        <div className='space-y-8'>
                            <div className='flex items-center gap-2'>
                                <FaCheckCircle className='text-green-400' />
                                <p className='text-[16px] text-white'>เรามีลูกค้าที่ไว้วางใจเราทั้งภาครัฐและเอกชน</p>
                            </div>
                            <div className='flex items-center gap-2'>
                                <FaCheckCircle className='text-green-400' />
                            ...
                            <div className="flex w-full flex-col gap-10 md:w-1/2 lg:flex-row lg:items-center">
                                ...
                                <div>
                                    ...
                                    <h3 className="mt-0.5 text-xl font-semibold text-gray-700 dark:text-white">
                                        Business Development ของ KPAuto Groups ซึ่งเป็น Dealer Top1 ชั้นนำของ Mazda , Mg เเละ Suzuki
                                    </h3>
            ...
            <div className='bg-[#101828] dark:bg-darkbg py-40 px-4'>
                <div className='container mx-auto '>
                    <div className='flex flex-col justify-center items-center space-y-4'>
                        ...
                        <p className='text-[16px] text-[#7f848c] text-center'>ให้เราช่วยคุณเปลี่ยนไอเดียเป็นธุรกิจ หรือ โปรแกรมที่ขับเคลื่อนธุรกิจคุณสู่ยุคดิจิตอล</p>
                        <button className='text-[16px] text-white bg-primary rounded-3xl py-2 px-4'>สอบถามบริการ</button>
                    </div>
                </div>
            </div>
