            ...
            <div className="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
              <div className="z-10">
                <h1 className="relative text-center text-4xl font-bold text-gray-900 dark:text-white sm:text-5xl md:text-6xl">
                  <span className="text-5xl sm:text-6xl lg:text-left lg:text-7xl font-bold bg-gradient-to-r from-blue-600 via-sky-500 to-indigo-400 inline-block text-transparent bg-clip-text">
                    บทความ
                  </span>
                </h1>
              </div>
