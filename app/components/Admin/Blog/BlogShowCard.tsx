...
const BlogShowCard: FC<Props> = ({ item, isProfile }) => {
  ...
  return (
    <>
      <a
        onClick={handleClick}
        className="block cursor-pointer rounded-3xl px-4 py-6 sm:border bg-[#F1F5F9] dark:bg-darkbg dark:sm:border-gray-800 sm:dark:bg-gray-800/50"
      >
        <img
        ...
        />
        <div className="mt-8">
          <h2 className="text-xl font-bold text-gray-800 dark:text-white md:text-3xl">
            {item.title}
          </h2>
