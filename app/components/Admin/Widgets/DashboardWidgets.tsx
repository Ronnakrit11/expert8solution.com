  ...
  return (
    <div className=" my-24 pl-8 sm:pl-8 md:pl-40 lg:pl-16 xl:pl-8" >
      <Box>
        <Grid container spacing={2} >
          ...
          <Grid item xs={12} md={4} padding={2}>
            <div className="w-full dark:bg-[#111C43] rounded-lg shadow">
              <div className="flex items-center p-5 justify-between">
                <div>
                  <BiBorderLeft className="dark:text-primary text-[#000] text-[30px]" />
                  <h5 className="pt-2 font-Poppins dark:text-[#fff] text-black text-[20px]">
                    {ordersComparePercentage?.currentMonth}
                  </h5>
                  <h5 className="py-2 font-Poppins dark:text-primary text-black text-[20px] font-[400]">
                    Sales Obtained
                  </h5>
                </div>
                <div>
            ...
            <div className="w-full dark:bg-[#111C43] rounded-lg shadow my-8 ">
              <div className="flex items-center p-5 justify-between">
                <div className="">
                  <PiUsersFourLight className="dark:text-primary text-[#000] text-[30px]" />
      ...
      {/* <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2">
        ...
        <div className="pt-[20px] sm:pt-[20px] lg:pt-[80px]">
