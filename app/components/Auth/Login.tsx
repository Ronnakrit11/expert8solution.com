  ...
  return (
    <Card >
      <div className="flex justify-center items-center">
        <p className='text-xl sm:text-2xl lg:text-left lg:text-3xl font-bold bg-gradient-to-r from-blue-600 via-sky-500 to-indigo-400 inline-block text-transparent bg-clip-text'>Login With Expert8Shop</p>
      </div>
