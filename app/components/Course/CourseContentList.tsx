        ...
        return (
          <div className={`${!props.isDemo && 'border-b border-[#0000001c] dark:border-[#ffffff8e] pb-2'}`} key={section}>
            <div className="w-full flex">
              ...
              >
                <h2 className="text-[22px] text-white dark:text-white">{section}</h2>
                <button
                  className="mr-4 cursor-pointer text-white dark:text-white"
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start">
                        ...
                        <h1 className="text-[18px] inline-block break-words text-white dark:text-white">
                          {item.title}
                        </h1>
                      </div>
                      <h5 className="pl-8 text-white dark:text-white">
