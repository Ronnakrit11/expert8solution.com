        ...
        <div className="w-full flex flex-col-reverse 800px:flex-row">
          <div className="w-full 800px:w-[65%] 800px:pr-5">
            ...
            <div className="flex items-center justify-between pt-3">
              <div className="flex items-center">
                ...
                <h5 className="text-white dark:text-white">{data.reviews?.length} Reviews</h5>
              </div>
              <h5 className="text-white dark:text-white">{data.purchased} Students</h5>
            </div>
              ...
              {data.benefits?.map((item: any, index: number) => (
                <div className="w-full flex 800px:items-center py-2" key={index}>
                  <div className="w-[15px] mr-1">
                    <IoCheckmarkDoneOutline size={20} className="text-white dark:text-white" />
                  </div>
                ...
                <div className="w-full pb-4" key={index}>
                  <div className="flex">
                    ...
                    <div className="hidden 800px:block pl-2">
                      ...
                      <p className="text-white dark:text-white">{item.comment}</p>
          ...
          <div className="w-full 800px:w-[35%] relative">
            <div className="sticky top-[100px] left-0 z-50 w-full">
              ...
              <br />
              <p className="pb-1 text-white dark:text-white"></p>
              <p className="pb-1 text-white dark:text-white"></p>
              <p className="pb-1 text-white dark:text-white"></p>
              <p className="pb-3 800px:pb-1 text-white dark:text-white"></p>
            </div>
          </div>
        </div>
      </div>
