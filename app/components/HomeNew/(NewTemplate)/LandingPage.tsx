            ...
            <div className='container mx-auto'>
                <div className='py-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2'>
                    <div className='flex flex-col justify-center'>
                        ...
                        <h2 className='my-6 lg:my-12 text-lg text-gray-600 dark:text-gray-300 sm:text-xl'>บริการจัดทำเว็ปไซต์ E-learning เเพลทฟอร์มการเรียนออนไลน์ครบวงจร เเละซอฟเเวร์ทุกประเภท </h2>
