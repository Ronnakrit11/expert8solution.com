...
const LandingPage = () => {
    return (
        <div className='container mx-auto'>
            <div className='my-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2'>
                <div className='flex flex-col justify-center'>
                    ...
                    <p className='my-6 lg:my-12 text-lg text-gray-600 dark:text-gray-300 sm:text-xl'>บริการสร้างระบบ E-Learning เเบบครบครัน พร้อมบริการงานกราฟฟิก งานตัดต่อ เเละเทคนิคยิงโฆษณาโดยมืออาชีพ</p>
                ...
                <div className='p-2'>
                    <img src='/mm233.webp' className='w-full' />
                </div>
            </div>
        </div>
    )
