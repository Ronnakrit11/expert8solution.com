            ...
            <div className='container mx-auto mp-32'>
                <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2'>
                    ...
                    <div className='flex flex-col justify-center'>
                        <h2 className='text-3xl font-bold text-gray-800 dark:text-white md:text-4xl xl:text-5xl'>เพราะเราเข้าใจในธุรกิจการเรียนออนไลน์</h2>
                        <p className='mt-8 text-gray-600 dark:text-gray-300'>ซัพพอร์ตฟังก์ชั่นทุกอย่างตามที่คุณต้องการ</p>
                        <p className='mb-12 mt-4 text-gray-600 dark:text-gray-300'>ทางเราเข้าใจความต้องการของสถาบันหรือครูผู้สอนดี เเละเราพัฒนาระบบให้ตอบสนองการใช้งานของลูกค้าได้ครบครับ</p>
                        <div>
