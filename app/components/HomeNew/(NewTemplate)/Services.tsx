            ...
            <div className='container mx-auto text-black dark:text-white py-20'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 xl:grid-cols-3 gap-4 text-black'>
                    <div className='flex flex-col gap-4'>
                        <div className='bg-gray-100 dark:bg-[#15131B]  h-[500px] rounded-xl flex flex-col'>
                        ...
                        <div className='bg-gray-100 dark:bg-[#15131B] p-8 space-y-4 h-[500px] rounded-xl flex flex-col'>
                            <img src='https://media.licdn.com/dms/image/D4D12AQErV5S_buj95w/article-cover_image-shrink_600_2000/0/1662363673907?e=2147483647&v=beta&t=FLqEHqQ_zKwj_8qH6Thrac6b2KhPN9yLjxHf0bOxw1A' className='w-full overflow-hidden object-cover rounded-xl opacity-70' />
                    ...
                    <div className='flex flex-col gap-4'>
                        <div className='bg-gray-100 dark:bg-[#15131B] p-8 space-y-4 h-[480px] rounded-xl flex flex-col'>
                        ...
                        <div className='bg-gray-100 dark:bg-[#15131B] p-8 space-y-4 h-[350px] rounded-xl flex flex-col'>
                        ...
                        <div className='bg-gray-100 dark:bg-[#15131B] space-y-4 h-[670px] rounded-xl flex flex-col justify-between'>
                    ...
                    <div className='flex flex-col gap-4'>
                        <div className='bg-gray-100 dark:bg-[#15131B] p-8 space-y-4 h-[320px] rounded-xl flex flex-col'>
                        ...
                        <div className='bg-gray-100  dark:bg-[#15131B] h-[480px] rounded-xl flex flex-col'>
                            <div className='flex-grow p-8 space-y-4'>
                        ...
                        <div className='bg-gray-100 dark:bg-[#15131B] p-8 space-y-4 h-[364px] rounded-xl flex flex-col'>
