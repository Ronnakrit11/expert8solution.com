                ...
                {tabState === 0
                    ...
                    <div className='mt-4 sm:mt-4 md:mt-10'>
                        <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2'>
                            ...
                            <div className='mt-4'>
                                <img src='/tap/phone11.png' className='mx-auto h-80 rounded-t-3xl object-cover object-top dark:border-transparent sm:h-[28rem]' />
                            </div>
                        </div>
                    </div>
                    : <></>
                ...
                {tabState === 1
                    ...
                    <div className='mt-4 sm:mt-4 md:mt-10'>
                        <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2'>
                            ...
                            <div className='mt-4'>
                                <img src='/tap/myipad.png' className='mx-auto h-80 w-full rounded-t-3xl object-cover object-top dark:border-transparent sm:h-[28rem]' />
                            </div>
                        </div>
                    </div>
                    : <></>
