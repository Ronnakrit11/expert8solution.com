  ...
  return (
    <div className="w-[80%] md:w-[55%] mx-auto">
      <div className="relative w-full" style={{ paddingBottom: "57.325%" }}>
        ...
        >
          <div className="h-20 md:h-60 bg-gradient-to-br from-purple-600 to-purple-400 blur-[106px] dark:from-blue-700"></div>
          <div className="h-10 md:h-40 bg-gradient-to-r from-cyan-400 to-sky-300 blur-[106px] dark:to-indigo-600"></div>
        </div>
        <iframe
