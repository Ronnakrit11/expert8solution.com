        ...
        <div className='overflow-x-clip pt-10'>
            <div className='mx-auto px-4 sm:px-12 xl:max-w-5xl xl:px-0'>
                ...
                <div className=' relative mt-20'>
                    <div aria-hidden="true" className="absolute inset-0 -bottom-20 mx-auto mt-auto h-[50rem] w-[68rem] rounded-full bg-purple-200 blur-3xl dark:bg-secondary/40 md:m-auto"></div>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="rounded-full bg-gradient-to-br from-purple-500 to-yellow-500 dark:from-primary dark:to-yellow-400">
                                        <div className="flex h-16 w-16 scale-[0.96] rounded-full bg-gray-900 dark:bg-white">
                                            <img src="https://tailus.io/sources/blocks/comparator/preview/images/organization.webp" className="m-auto h-8 w-auto" alt="organization icon" />
                                        </div>
                                    </div>
                                    <div>
